...
public class YolimeBlock extends SlimeBlock {
    ...
    private void bounceUp(Entity entity) {
        ...
        if (vec3.y < 0.0) {
            ...
            entity.setDeltaMovement(vec3.x, Math.min(-vec3.y * d0, getBounceVelocityCap()), vec3.z);
        }
    }
    ...
    private double getBounceVelocityCap(){
        return ServerConfig.YOLIME_BLOCK_BOUNCE_VELOCITY_CAP.get();
    }
}

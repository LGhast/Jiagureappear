...
public class YaowangTrigger extends SimpleCriterionTrigger<YaowangTrigger.Instance> {
    ...
    public static Criterion<Instance> yaowang() {
    ...
    public static final DeferredHolder<CriterionTrigger<?>, YaowangTrigger> TRIGGER =
            TRIGGER_TYPES.register("yaowang", YaowangTrigger::new);
}

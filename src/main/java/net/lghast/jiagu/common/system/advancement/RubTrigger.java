...
public class RubTrigger extends SimpleCriterionTrigger<RubTrigger.Instance> {
    ...
    public static final DeferredHolder<CriterionTrigger<?>, RubTrigger> TRIGGER =
            TRIGGER_TYPES.register("rub", RubTrigger::new);
}
